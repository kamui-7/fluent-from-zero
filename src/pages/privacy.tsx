    ...
    <Layout>
      <div className="legal-info">
        ...
        <p>
          ...
          by Fluent From Zero and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Fluent From Zero. This policy is not
        ...
        <p>
          Fluent From Zero follows a standard procedure of using log files.
        ...
        <p>
          ...
          advertising partners of Fluent From Zero.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Fluent From Zero, which are
        ...
        <p>
          Note that Fluent From Zero has no access to or control over these
        ...
        <p>
          Fluent From Zero's Privacy Policy does not apply to other advertisers
        ...
        <p>
          Fluent From Zero does not knowingly collect any Personal Identifiable
