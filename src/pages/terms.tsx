  ...
  return (
    <Layout>
      <div className="terms">
        ...
        <p>
          By accessing this Website, accessible from fluentzero.com, you are
        ...
        <p>
          ...
          materials on Fluent From Zero's Website for personal, non-commercial
        ...
        <p>
          This will let Fluent From Zero to terminate upon violations of any of
        ...
        <p>
          All the materials on Fluent From Zero’s Website are provided "as is".
          Fluent From Zero makes no warranties, may it be expressed or implied,
          therefore negates all other warranties. Furthermore, Fluent From Zero
        ...
        <p>
          Fluent From Zero or its suppliers will not be hold accountable for any
          damages that will arise with the use or inability to use the materials
          on Fluent From Zero’s Website, even if Fluent From Zero or an
        ...
        <p>
          The materials appearing on Fluent From Zero’s Website may include
          technical, typographical, or photographic errors. Fluent From Zero
          will not promise that any of the materials in this Website are
          accurate, complete, or current. Fluent From Zero may change the
          materials contained on its Website at any time without notice. Fluent
          From Zero does not make any commitment to update the materials.
        </p>

        <h2>6. Links</h2>

        <p>
          Fluent From Zero has not reviewed all of the sites linked to its
          Website and is not responsible for the contents of any such linked
          site. The presence of any link does not imply endorsement by Fluent
          From Zero of the site. The use of any linked website is at the user’s
          own risk.
        </p>
        ...
        <p>
          Fluent From Zero may revise these Terms of Use for its Website at any
        ...
        <p>
          Any claim related to Fluent From Zero's Website shall be governed by
